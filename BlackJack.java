...
public class BlackJack {
 ...
 public static void main(String[] args) throws InterruptedException {
  ...
  while(player.getMoney() > 0.0) {
   ...
   // create the expectimax tree
   Expectimax expectimaxTree = new Expectimax(player.getCard(0), player.getCard(1), dealer.getCard(0), dealer.getCard(1));
   player.setExpectimax(expectimaxTree);
